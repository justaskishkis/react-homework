import { IApiResponse } from '../../../features/api/api.models';
import { RouteComponentProps } from 'react-router-dom';

export interface IHero extends IApiResponse {
	id: number;
	name: string;
...
export enum IHeroesActionTypes {
...
export type IHeroesProps = IHeroesState & RouteComponentProps;
